...
const CrewImage = ({ crewMember, isActive }: { crewMember: CrewMember; isActive: boolean }) => {
  return (
    <div
      ...
      } col-start-1 row-start-1 flex  flex-col items-center justify-end justify-self-stretch md:row-start-3 md:translate-y-6 md:transform lg:translate-y-6`}>
      <Image
        src={crewMember.images.webp}
        alt={crewMember.name}
        width={800}
        height={800}
        className={'h-[13.75rem] object-contain md:h-[33rem]'}
      />
